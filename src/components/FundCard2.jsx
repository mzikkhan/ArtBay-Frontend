...
const FundCard2 = ({ seller, buyer, amount, id, artId, handleClick }) => {
  
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer" onClick={handleClick}>
      <img src='./src/assets/copyright.png' alt="fund" className="w-full h-[158px] object-cover rounded-[15px]"/>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="block">
          <h3 className="font-epilogue font-semibold text-[16px] text-white text-left leading-[26px] truncate">{seller}</h3>
          <p className="mt-[5px] font-epilogue font-normal text-[#808191] text-left leading-[18px] truncate">Title: {buyer}</p>
        </div>
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          ...
          <div className="flex flex-col">
            <h4 className="font-epilogue font-semibold text-[14px] text-[#b2b3bd] leading-[22px]">Price: {amount} ETH</h4>
